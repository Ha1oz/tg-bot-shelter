...
/**
 * Обработчик для колбэков связанных с вызовом волонтеров.
 */
public class VolunteerCallbackHandler implements CallbackChainHandler{

    /**
     * Проверяет, соответствует ли колбэк необходимым условиям обработчика вызова волонтера.
     *
    ...
    /**
     * Обрабатывает колбэк связанный с вызовом волонтеров и возвращает EditMessageText объект с обновленным текстом
     * сообщения или null, если колбэк не обрабатывается обработчиком.
     *
     * @param update Обновление от Telegram API
