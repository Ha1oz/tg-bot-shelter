...
public class ShelterDogCallbackHandlerImpl implements CallbackChainHandler {
    ...
    public boolean check(Update update) {
        ...
        return callbackQuery != null && callbackQuery.data().startsWith("shelter_dogs");
    }
    ...
    public EditMessageText handle(Update update) {
        ...
        InlineKeyboardMarkup inlineKeyboard = new InlineKeyboardMarkup(
                new InlineKeyboardButton("Info").callbackData("info_dog" + params[1]),
                new InlineKeyboardButton("Get animal").callbackData("get_dog" + params[1]),
