...
public interface CallbackChainHandler {
    ...
    /**
     * Обрабатывает обновление колбэков и возвращает EditMessageText объект с обновленным текстом сообщения или null,
     * если обновление не обрабатывается обработчиком.
     *
     * @param update Обновление от Telegram API
     * @return EditMessageText объект с обновленным текстом сообщения или null, если обновление не обрабатывается
     * обработчиком.
     */
